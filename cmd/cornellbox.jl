...
redwallmarkers = group(Vector{Sphere}(
    [
        Sphere(Vec3(0f0, 0f0, 0f0), 10f0, green),
        Sphere(Vec3(-277.5f0, -277.5f0, 0f0), 10f0, blue),
        Sphere(Vec3(-277.5f0,  277.5f0, 0f0), 10f0, blue),
        Sphere(Vec3( 277.5f0, -277.5f0, 0f0), 10f0, blue),
        Sphere(Vec3( 277.5f0,  277.5f0, 0f0), 10f0, blue),
    ]
...
redwall = uniformwall(555f0, 555f0, 1000, redlambert)
# redtransform = translation(555f0, 0f0, 0f0) * rotation(Float32(-π / 2f0), Vec3(0f0, 1f0, 0f0))
redtransform = translation(277.5f0, 277.5f0, 0f0)
